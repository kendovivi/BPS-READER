package jp.bpsinc.android.viewer.epub.omf.preference.activity;
...
public class OmfEpubViewerPreferenceActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
	/** 回転設定 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.omf_epub_viewer_preference);

		mOrientationPreference = (ListPreference) findPreference(getString(R.string.pre_key_omf_epub_viewer_orientation));
		mAnimationPreference = (ListPreference) findPreference(getString(R.string.pre_key_omf_epub_viewer_animation));
		mBrightnessPreference = (BrightnessPreference) findPreference(getString(R.string.pre_key_omf_epub_viewer_brightness));
